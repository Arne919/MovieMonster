...
const deleteComment = (articleId, commentId) => {
  ...
  return { articles, API_URL, addComment, getComments, getArticles, signUp, logIn, token, isLogin, logOut, Username, fetchUserPoints, user, displayStars, fetchRankings, rankings, updateComment, deleteComment, formatDate, getSortedArticles}
}, { persist: true })